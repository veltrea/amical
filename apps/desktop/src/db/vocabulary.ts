...
/**
 * Load every manually-authored vocabulary row. The ASR pipeline unions these
 * with the entries of activated bundled dictionaries (read from JSON assets,
 * not the DB) — see SPEC-dictionary-library.md §5 (model B). Also used by the
 * export feature and the settings UI list.
 */
